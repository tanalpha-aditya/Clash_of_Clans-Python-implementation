...
from characters import spawnBarbarian, move_barbarians, spawnStArcher, move_starchers, spawnArcher, move_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, spawnHealer, move_healers, clearTroops
